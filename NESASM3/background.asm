...
LoadBackgroundLoop:
  ...
  STA $2007             ; write to PPU
  INX                   ; X = X + 1
  CPX #$00              ; Compare X to hex $A0, decimal 192 - copying 160 bytes
  BNE LoadBackgroundLoop  ; Branch to LoadBackgroundLoop if compare was Not Equal to zero
                        ; if compare was equal to 192, keep going down
...
LoadAttributeLoop:
  ...
  STA $2007             ; write to PPU
  INX                   ; X = X + 1
  CPX #$10              ; Compare X to hex $10, decimal 16 - copying 16 bytes
  BNE LoadAttributeLoop  ; Branch to LoadAttributeLoop if compare was Not Equal to zero
                        ; if compare was equal to 10, keep going down
...
ReadUp:
  ...
  LDA $0200     ; load sprite 0 Y pos
  SEC           ; set carry flag
  SBC #$01      ; A--
  STA $0200     ; save position

  LDA $0204     ; load sprite 1 Y pos
  SEC           ; set carry flag
  SBC #$01      ; A--
  STA $0204     ; save position

  LDA $0208     ; load sprite 2 Y pos
  SEC           ; set carry flag
  SBC #$01      ; A--
  STA $0208     ; save position

  LDA $020C     ; load sprite 3 Y pos
  SEC           ; set carry flag
  SBC #$01      ; A--
  STA $020C     ; save position
ReadUpDone:     ; handling finished
...
;;;;;;;;;;;;;;  
  ...
  .org $E000
palette:
  .db $1B,$1B,$1B,$1B,  $1B,$1B,$1B,$1B,  $1B,$1B,$1B,$1B,  $1B,$1B,$1B,$1B, $24,$1C,$15,$14,  $22,$02,$38,$3C,  $22,$1C,$15,$14,  $22,$02,$38,$3C   ;;sprite palette
...
attribute:
  ...
  .db %00000000, %00010001, %01010101, %00010001, %00000000, %00000000, %00000000, %00110011
